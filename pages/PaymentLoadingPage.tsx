...
const PaymentLoadingPage: React.FC<PaymentLoadingPageProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-hegra-white text-hegra-navy p-4 text-center">
      ...
      <h1 className="text-2xl md:text-3xl font-bold mt-8 mb-2">Processing Your Payment...</h1>
      <p className="text-gray-600">Please wait a moment, we are finalizing your order.</p>
      <p className="text-sm text-gray-500 mt-1">Do not close or refresh this page.</p>
