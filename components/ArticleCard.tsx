...
const ArticleCard: React.FC<ArticleCardProps> = ({
  ...
  const categoryColors: { [key: string]: string } = {
    'Tips & Tricks': 'bg-hegra-turquoise text-white',
    'Case Study': 'bg-hegra-yellow text-hegra-navy',
    'Insights': 'bg-hegra-navy text-white',
    'News': 'bg-red-500 text-white', // Example additional category
